...
// Now $user->delete() sets deleted_at instead of removing the row`}
    </pre>
...
$orders = Order::with('user')->get(); // One query, not N+1`}
    </pre>
...
export default DatabaseDesignPost;
